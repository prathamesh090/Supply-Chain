...
try:
    ...
    PLASTIC_INHERENT_RISK_MODULES_AVAILABLE = True
except ImportError as e:
    print(f"Note: Plastic inherent risk modules not available: {e}")
    PLASTIC_INHERENT_RISK_MODULES_AVAILABLE = False
...
if SUPPLIER_RISK_AVAILABLE:
    ...
    print("[OK] Supplier risk routes registered")
else:
    print("[FAIL] Supplier risk routes not available")

if PLASTIC_INHERENT_RISK_AVAILABLE:
    app.include_router(plastic_inherent_risk_router)
    print("[OK] Plastic inherent risk routes registered")
else:
    print("[FAIL] Plastic inherent risk routes not available")
...
try:
    ...
    print("[OK] Inventory routes registered")
except Exception as e:
    print(f"[FAIL] Inventory routes not available: {e}")

# Route Optimization
try:
    app.include_router(ro_router)
    print("[OK] Route Optimization routes registered")
except Exception as e:
    print(f"[FAIL] Route Optimization routes not available: {e}")
...
try:
    ...
    print("[OK] Risk event monitoring routes registered")
except Exception as e:
    print(f"[FAIL] Risk event monitoring routes not available: {e}")

# Integrated Risk Router
try:
    app.include_router(integrated_risk_router)
    print("[OK] Integrated risk routes registered")
except Exception as e:
    print(f"[FAIL] Integrated risk routes not available: {e}")

# Global Risk Router
try:
    app.include_router(global_risk_router)
    print("[OK] Global risk routes registered")
except Exception as e:
    print(f"[FAIL] Global risk routes not available: {e}")

# Global Risk Feed Router
try:
    app.include_router(risk_feed_router)
    print("[OK] Risk feed routes registered")
except Exception as e:
    print(f"[FAIL] Risk feed routes not available: {e}")
...
async def startup_event():
    ...
    if PLASTIC_INHERENT_RISK_MODULES_AVAILABLE:
        try:
            init_db()
        except Exception as e:
            logger.error(f"✗ Plastic inherent risk DB initialization failed: {e}")
    
    load_global_events()
    print("[OK] Global geopolitical events loaded")
    ...
    if PLASTIC_INHERENT_RISK_MODULES_AVAILABLE:
        try:
            ...
            news_thread.start()
            logger.info("[OK] News simulation engine running")
        except Exception as e:
